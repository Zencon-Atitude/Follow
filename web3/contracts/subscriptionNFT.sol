...
contract subscriptionNFT is ERC721URIStorage, IERC5643, Ownable {
    ...
    constructor() ERC721("SubscriptionFollowTheLead", "SFTL") {}

    function mintSubscriptionNFT(address recipient, string memory tokenURI) public onlyOwner returns (uint256)
    {
        _tokenIds.increment();
    ...
    function getSubscriptionByTokenId(uint256 tokenId) public view returns (string memory) {
